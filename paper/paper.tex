...
\paragraph{LLM-as-judge.} Our benchmark relies on an LLM judge to classify model behavior. \citet{zheng2023judging} validated this paradigm with MT-Bench and Chatbot Arena, showing that GPT-4 achieves over $80\%$ agreement with human preference ratings. We validate our own judge in Section~\ref{sec:abl-judges} by running four different judge models on the same transcripts and measuring inter-judge agreement.
